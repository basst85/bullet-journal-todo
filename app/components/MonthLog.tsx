...
export default function MonthLog() {
  ...
  const onDragEnd = (result: DropResult) => {
    ...
    if (sourceId === destinationId) {
      ...
      const sourceParentId = sourceId === 'monthTasks' ? null : sourceId.split('-')[1]
      const destinationParentId = destinationId === 'monthTasks' ? null : destinationId.split('-')[1]
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-4">Month Log</h2>
